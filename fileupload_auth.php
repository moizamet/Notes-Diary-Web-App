 ...
 <div style="padding-bottom : 30px;">
        <div class="col-lg-offset-3" style="font-size: 16px;" >
         ...
         <h3 align="center"> Please Login To Upload Your Valueable Content</h3>
         <center>
          
        <a  href="file_upload.php" class="btn btn-lg btn-primary text-center" style="width:200px;">Register </a>
        <a  href="login.php" class="btn btn-lg btn-primary text-center" style="width:200px;">Login </a>
